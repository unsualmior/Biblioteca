...
class LibrariansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create librarian" do
    assert_difference("Librarian.count") do
      post librarians_url, params: { librarian: { email: @librarian.email, first_access: @librarian.first_access, name: @librarian.name, password_digest: @librarian.password_digest } }
    end
  ...
  test "should update librarian" do
    patch librarian_url(@librarian), params: { librarian: { email: @librarian.email, first_access: @librarian.first_access, name: @librarian.name, password_digest: @librarian.password_digest } }
